const questions = [
...

    {
        id: "q6",
        type: "multiple-choice",
        question: "Hva er hensikten med å lage et database-abstraksjonslag?",
        options: [
...

    {
        id: "q14",
        type: "multiple-choice",
        question: "Hva gjør `invalidateQueries({ queryKey: ['students'] })`?",
        options: [
            "Sletter databasen",
...

    {
        id: "q16",
        type: "multiple-choice",
        question: "Hva er hovedforskjellen på offset- og cursor-paginering?",
        options: [
...
export const api_quiz = {
    ...
    theme: ["react-native", "api", "validering"],
    questions: [...questions],
};
